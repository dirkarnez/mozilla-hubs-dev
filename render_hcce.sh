export PATH="$PATH:/C/Users/stude/Downloads/node-v18.18.0-win-x64/node-v18.18.0-win-x64:/C/Program Files/Docker/Docker/resources/bin"

export OPENSSL_CONF=/C/Users/stude/Downloads/openssl-3.1.3/openssl-3/ssl/openssl.cnf
...
###
/C/Users/stude/Downloads/openssl-3.1.3/openssl-3/x64/bin/openssl genpkey -algorithm RSA -out private_key.pem -pkeyopt rsa_keygen_bits:2048
echo "!!!!A\n"
export PERMS_KEY="$(echo -n "$(awk '{printf "%s\\\\n", $0}' private_key.pem)")"
echo "!!!!B\n"
/C/Users/stude/Downloads/openssl-3.1.3/openssl-3/x64/bin/openssl ec -pubout -in private_key.pem -out public_key.pem
echo "!!!!C\n"
#sudo apt-get install npm && sudo npm install -g pem-jwk
export PGRST_JWT_SECRET=$(pem-jwk public_key.pem)

### initial cert
/C/Users/stude/Downloads/openssl-3.1.3/openssl-3/x64/bin/openssl req -x509 -newkey rsa:2048 -sha256 -days 36500 -nodes -keyout key.pem -out cert.pem -subj '//CN=localhost'
